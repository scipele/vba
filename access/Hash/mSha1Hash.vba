...
Sub test()
    Dim str As String
    str = "Test Hashing of this long text string BALL - API 608; SPLIT BODY OR UNI-BODY; FLOATING BALL; CL 600; SW; LOTEMP CS (A352-LCB); FP; PTFE SELF RELIEVING SEATS; BOLTED COVER; API 622 APPROVED GRPH PACKING & GRAPHITE BODY GASKET; LOW TEMP BOLTING; LOCKING LEVER (QUALIFIED TO API 607); Sch S-XS x S-80"
    
    Debug.Print GetSha1Hash(str)
End Sub
