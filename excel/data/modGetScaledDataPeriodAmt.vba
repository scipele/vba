...
'
' Example usage in spreadsheet in column F Table2 data.body cells
'
...
Public Function GetScaledDataPeriodAmt(ByRef origAmts As Range, _
    ...
    ' now compute the items that have an overlapping range
    ...
    Dim indx As Long
    Dim x0 As Double 'proportionate fraction at period start(x0)
    Dim x1 As Double 'proportionate fraction at period end(x1)
    Dim frac As Double
